...
import { getEmbedUrlData } from "@/helpers/getEmbedUrlData";
...
export const MediaEmbedElement = withHOC(
  ...
  withRef<typeof PlateElement>(({ children, className, ...props }, ref) => {
    const {
      ...
      urlParsers: [getEmbedUrlData, parseVideoUrl],
    });
                  ...
                  >
                    <iframe
                      ...
                      className={cn(
                        ...
                        focused &&
                          selected &&
                          "ring-2 ring-zinc-950 ring-offset-2 dark:ring-zinc-300"
                      )}
                      src={embed!.url}
                      title="embed"
                    />
              ...
              {isTweet && (
                <div
                  className={cn(
                    ...
                    !readOnly &&
                      selected &&
                      "[&_.react-tweet-theme]:ring-2 [&_.react-tweet-theme]:ring-zinc-950 [&_.react-tweet-theme]:ring-offset-2 dark:[&_.react-tweet-theme]:ring-zinc-300"
                  )}
                >
                  <Tweet id={embed!.id!} />
                </div>
