...
export function EmojiPickerNavigation({
  ...
  return (
    <nav id="emoji-nav" className="bg-[#161a1d] mb-2.5 p-3">
        ...
        {emojiLibrary
          ...
          .map(({ id }) => (
            <button
              ...
              type="button"
              className={cn(
                "flex grow cursor-pointer items-center justify-center border-none fill-current text-sm text-gray-500 hover:text-blue-600",
                id === focusedCategory &&
